...
class FileViewTestCase extends PHPUnit_Framework_TestCase
{
	public function testInlineFileView()
	{
		...
		$file = new AeFramework\InlineFileView(__FILE__, 'application/x-httpd-php');
	...
	{
		# Create a download test with this source file
		$file = new AeFramework\DownloadFileView(__FILE__, 'application/x-httpd-php', 'FileViewTestCase.php');
